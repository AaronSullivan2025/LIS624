...
Steps: 
•	Played around with -i and -c options, before moving on to each of the -A, -B, and -C NUM commands. 
•	Played around with case matching, sort, and counts, first with the arobas (“@”) and then with various 8-, 9-, and 10-letter words. 
•	Tried out cut and sed. 

Results: Successful
Verification: 
Tested as per the steps listed in our documentation and encountered only issue with trying to access Scopus. Had to use Web of Science isntead
